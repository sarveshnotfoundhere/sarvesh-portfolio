  ...
  return (
    <Float speed={1.7} rotationIntensity={0.08} floatIntensity={0.12}>
      <group ref={group} scale={0.55} position={[1.65, -0.7, 0.25]}>
        <mesh position={[0, 0.25, 0]}><sphereGeometry args={[0.5, 24, 24]} /><meshStandardMaterial color="#b9d8f6" roughness={0.32} metalness={0.15} /></mesh>
...
export default function PortfolioMascot() {
  return (
    <div className="mascot-layer">
      <div className="mascot-canvas" aria-hidden="true">
