    ...
    <main className="site-shell home-space">
      ...
      <section id="about" className="about-section section section-dark">
        ...
        <div className="about-grid">
          <div className="about-card"><span>01</span><strong>FINANCE</strong><p>Analysis, accounting and business thinking with a practical, learning-first approach.</p></div>
          <div className="about-card"><span>02</span><strong>COMMUNICATION</strong><p>Reporting, presentation and audience-facing work across student organisations and digital roles.</p></div>
          <div className="about-card"><span>03</span><strong>CREATIVE</strong><p>Graphic design and media work that turns ideas into clear, memorable visual systems.</p></div>
        </div>
      </section>
